...
<p className="hero-desc">ECCOOZS is coming. A warmer, cleaner, more intentional 18+ ecosystem for community, creators, businesses, products, conversations, and trusted discovery.</p>
...
<div className="sp-av">A</div><div className="sp-av">K</div><div className="sp-av">M</div><div className="sp-av">J</div>
...
<div className="fs-item"><div className="fs-icon"><Icon name="mic-2" /></div><div><div className="fs-label">Soundrooms</div><div className="fs-desc">Speak. Listen. Connect.<br />Real conversations. Real time.</div></div></div>
<div className="fs-item"><div className="fs-icon"><Icon name="layout-grid" /></div><div><div className="fs-label">The Flow</div><div className="fs-desc">Your feed. Your culture.<br />Content that reflects you.</div></div></div>
<div className="fs-item"><div className="fs-icon"><Icon name="trending-up" /></div><div><div className="fs-label">Elevate</div><div className="fs-desc">Creators. Brands. Impact.<br />Build, grow, inspire.</div></div></div>
<div className="fs-item"><div className="fs-icon"><Icon name="calendar-check" /></div><div><div className="fs-label">Events</div><div className="fs-desc">Live. Local. Elevated.<br />Experiences that bring us together.</div></div></div>
</div>
</section>
...
<p className="echo-quote">On Eccoozs, you don't go <em>"viral."</em><br />What you say or do <em>echoes.</em><br />Make sure you echo in a positive way.</p>
<p className="echo-body">We built a platform that holds content and creators to a higher standard. No toxic algorithms feeding outrage. No hollow metrics chasing clout. Just authentic voices, resonating with real people.</p>
</div>
</section>
<section id="features">
<div className="fi rv">
...
<p className="sdesc light" style={{ margin: "0 auto 2.5rem", textAlign: "center" }}>Be among the first to know when ECCOOZS opens. Members, creators, businesses, advertisers, and beta testers can register interest below.</p>
...
<div><div className="fct">Platform</div><ul className="fls"><li><a href="#features">Features</a></li><li><a href="#app-preview">App</a></li><li><a href="#download">Join Waitlist</a></li><li><a href="#">Soundrooms</a></li><li><a href="https://eccoozs.com/shop" target="_blank">Shop</a></li></ul></div>
